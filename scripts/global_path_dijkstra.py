...
class dijkstra_path_pub :
    def __init__(self):
        ...
        load_path = os.path.normpath(os.path.join(current_path, 'lib/mgeo_data/R_KR_PR_SeongnamCityHall'))
        ...
        # self.start_node = '154S'
        # self.end_node = '3S'

        ### ADD NODE list
        # self.node_list = ['154S','154E','3E','9E', '121S', '121E', '141S', '32E', '68S', '75S', '75E', '73S', '80E', '85S', '30E', '82S', '86E', '78S', '73E', '74S', '31E', '124S', '124E', '119E', '122S', '8E', '3S', 'ND000006', 'ND000008', '111E', '111S', '203S']
        # self.node_list = ['154S', '9E', '32E', '73S', '85S', '3S', '203S']
        self.node_list = ['154S','203S']
